...
const variants: Variant[] = [
  // Phase A: baseline + minGap sweep (no filter)
  { name: "edge · 3:1 · minGap=0.15 (default)",          params: basePs(),                                         filters: {} },
  { name: "edge · 3:1 · minGap=0.30 (ETH winner)",       params: basePs({ minGapAtrMul: 0.30 }),                   filters: {} },
  ...
  // Phase B: BUY-only asymmetry test (Gold OB + Sweep both showed strong BUY edge)
  { name: "edge · 3:1 + BUY-only",                       params: basePs(),                                         filters: { buyOnly: true } },
  { name: "edge · 3:1 + BUY · minGap=0.30",              params: basePs({ minGapAtrMul: 0.30 }),                   filters: { buyOnly: true } },
  { name: "edge · 3:1 + BUY · minGap=0.50",              params: basePs({ minGapAtrMul: 0.50 }),                   filters: { buyOnly: true } },
  { name: "edge · 3:1 + BUY · minGap=0.70",              params: basePs({ minGapAtrMul: 0.70 }),                   filters: { buyOnly: true } },
  // R:R sweep with BUY
  ...
  { name: "edge · 6:1 + BUY",                            params: basePs({ targetRMult: 6.0 }),                     filters: { buyOnly: true } },
  { name: "edge · 4:1 + BUY · minGap=0.30",              params: basePs({ targetRMult: 4.0, minGapAtrMul: 0.30 }), filters: { buyOnly: true } },
  { name: "edge · 4.5:1 + BUY",                          params: basePs({ targetRMult: 4.5 }),                     filters: { buyOnly: true } },
  // Phase C: SELL-only as control (expect catastrophic)
  { name: "edge · 3:1 + SELL-only (control)",            params: basePs(),                                         filters: { sellOnly: true } },
  // Phase D: ETH-OB style filters
  { name: "edge · 3:1 + with-trend@20",                  params: basePs(),                                         filters: { withTrendOnlyAboveAdx: 20 } },
  { name: "edge · 6:1 + with-trend@20",                  params: basePs({ targetRMult: 6.0 }),                     filters: { withTrendOnlyAboveAdx: 20 } },
  { name: "edge · 4:1 + BUY + with-trend@20",            params: basePs({ targetRMult: 4.0 }),                     filters: { buyOnly: true, withTrendOnlyAboveAdx: 20 } },
  // Phase E: entry depth
  { name: "ce · 4:1 + BUY",                              params: basePs({ entryDepth: 1, targetRMult: 4.0 }),      filters: { buyOnly: true } },
  { name: "far · 4:1 + BUY",                             params: basePs({ entryDepth: 2, targetRMult: 4.0 }),      filters: { buyOnly: true } },
  // Phase F: rejection filter
  { name: "edge · 4:1 + BUY + rejection",                params: basePs({ targetRMult: 4.0, requireRejection: 1 }), filters: { buyOnly: true } },
  // Phase G: combined champions
  { name: "edge · 4:1 + BUY · minGap=0.5",               params: basePs({ targetRMult: 4.0, minGapAtrMul: 0.5 }),  filters: { buyOnly: true } },
  { name: "edge · 4:1 + BUY · minGap=0.7",               params: basePs({ targetRMult: 4.0, minGapAtrMul: 0.7 }),  filters: { buyOnly: true } },
  { name: "edge · 5:1 + BUY · minGap=0.3",               params: basePs({ targetRMult: 5.0, minGapAtrMul: 0.3 }),  filters: { buyOnly: true } },
];
