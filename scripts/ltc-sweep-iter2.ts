...
const variants: Variant[] = [
  // ITER1 WIN: confirm 4:1 + swing1 + SELL = 50t / 20% WR / +$613.86
  { name: "WIN: confirm 4:1 + swing1 + SELL",             params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1 }), filters: { sellOnly: true } },
  // R:R sweep around 4:1
  { name: "swing1+SELL · 3:1",                            params: basePs({ entryOnSweep: 0, targetRMult: 3.0, swingLeft: 1, swingRight: 1 }), filters: { sellOnly: true } },
  { name: "swing1+SELL · 5:1",                            params: basePs({ entryOnSweep: 0, targetRMult: 5.0, swingLeft: 1, swingRight: 1 }), filters: { sellOnly: true } },
  { name: "swing1+SELL · 6:1",                            params: basePs({ entryOnSweep: 0, targetRMult: 6.0, swingLeft: 1, swingRight: 1 }), filters: { sellOnly: true } },
  { name: "swing1+SELL · 4.5:1",                          params: basePs({ entryOnSweep: 0, targetRMult: 4.5, swingLeft: 1, swingRight: 1 }), filters: { sellOnly: true } },
  // Confirmation window
  { name: "swing1+SELL · 4:1 · cw=4",                     params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1, confirmationWindow: 4 }), filters: { sellOnly: true } },
  { name: "swing1+SELL · 4:1 · cw=5",                     params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1, confirmationWindow: 5 }), filters: { sellOnly: true } },
  { name: "swing1+SELL · 4:1 · cw=6",                     params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1, confirmationWindow: 6 }), filters: { sellOnly: true } },
  { name: "swing1+SELL · 4:1 · cw=2",                     params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1, confirmationWindow: 2 }), filters: { sellOnly: true } },
  // eqTol
  { name: "swing1+SELL · 4:1 · eqTol=0.15",               params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1, equalToleranceAtrMul: 0.15 }), filters: { sellOnly: true } },
  { name: "swing1+SELL · 4:1 · eqTol=0.2",                params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1, equalToleranceAtrMul: 0.2 }), filters: { sellOnly: true } },
  // lookbackBars
  { name: "swing1+SELL · 4:1 · lbBars=80",                params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1, lookbackBars: 80 }), filters: { sellOnly: true } },
  { name: "swing1+SELL · 4:1 · lbBars=100",               params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1, lookbackBars: 100 }), filters: { sellOnly: true } },
  // Day filters
  { name: "swing1+SELL · 4:1 · skipSat",                  params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1 }), filters: { sellOnly: true, skipDaysOfWeekUtc: [6] } },
  { name: "swing1+SELL · 4:1 · skipSatSun",               params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1 }), filters: { sellOnly: true, skipDaysOfWeekUtc: [0, 6] } },
  // Combined stacks
  { name: "swing1+SELL · 4:1 · cw=6 · eqTol=0.15",        params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1, confirmationWindow: 6, equalToleranceAtrMul: 0.15 }), filters: { sellOnly: true } },
  { name: "swing1+SELL · 4:1 · cw=6 · lbBars=80",         params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1, confirmationWindow: 6, lookbackBars: 80 }), filters: { sellOnly: true } },
