...
const variants: Variant[] = [
  // ITER7 WIN: $780.08
  { name: "WIN-7: stopBuf=0.25",                          params: W(),                                                       filters: { sellOnly: true } },
  // R:R sweep at the new winner (lower stop = more flexibility)
  { name: "R3:1",                                         params: W({ targetRMult: 3.0 }),                                   filters: { sellOnly: true } },
  { name: "R3.5:1",                                       params: W({ targetRMult: 3.5 }),                                   filters: { sellOnly: true } },
  { name: "R4.5:1",                                       params: W({ targetRMult: 4.5 }),                                   filters: { sellOnly: true } },
  { name: "R5:1",                                         params: W({ targetRMult: 5.0 }),                                   filters: { sellOnly: true } },
  { name: "R6:1",                                         params: W({ targetRMult: 6.0 }),                                   filters: { sellOnly: true } },
  { name: "R7:1",                                         params: W({ targetRMult: 7.0 }),                                   filters: { sellOnly: true } },
  // minEqualCount sweep (haven't tested this since iter 1)
  { name: "+ minEqual=3",                                 params: W({ minEqualCount: 3 }),                                   filters: { sellOnly: true } },
  // ADX gates on top
  { name: "+ minAdx=18",                                  params: W(),                                                       filters: { sellOnly: true, minAdx: 18 } },
  { name: "+ minAdx=22",                                  params: W(),                                                       filters: { sellOnly: true, minAdx: 22 } },
  { name: "+ minAdx=24",                                  params: W(),                                                       filters: { sellOnly: true, minAdx: 24 } },
  { name: "+ maxAdx=40",                                  params: W(),                                                       filters: { sellOnly: true, maxAdx: 40 } },
  { name: "+ maxAdx=50",                                  params: W(),                                                       filters: { sellOnly: true, maxAdx: 50 } },
  { name: "+ maxAdx=60",                                  params: W(),                                                       filters: { sellOnly: true, maxAdx: 60 } },
  { name: "+ withTrend@20",                               params: W(),                                                       filters: { sellOnly: true, withTrendOnlyAboveAdx: 20 } },
  // Day filters (haven't tested with the final stack)
  { name: "+ skipSat",                                    params: W(),                                                       filters: { sellOnly: true, skipDaysOfWeekUtc: [6] } },
  { name: "+ skipSatSun",                                 params: W(),                                                       filters: { sellOnly: true, skipDaysOfWeekUtc: [0, 6] } },
  // Asymmetric swing (haven't tested with final stack)
  { name: "+ swing1L2R",                                  params: W({ swingLeft: 1, swingRight: 2 }),                        filters: { sellOnly: true } },
  { name: "+ swing2L1R",                                  params: W({ swingLeft: 2, swingRight: 1 }),                        filters: { sellOnly: true } },
  { name: "+ swing2L2R",                                  params: W({ swingLeft: 2, swingRight: 2 }),                        filters: { sellOnly: true } },
  // Combined safe stacks
  { name: "+ minAdx=18 + skipSat",                        params: W(),                                                       filters: { sellOnly: true, minAdx: 18, skipDaysOfWeekUtc: [6] } },
  { name: "R5:1 + maxAdx=50",                             params: W({ targetRMult: 5.0 }),                                   filters: { sellOnly: true, maxAdx: 50 } },
];
