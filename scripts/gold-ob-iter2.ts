...
const variants: Variant[] = [
  // CE entry was best in iter1 (-$25). Build around CE.
  { name: "ce · 3:1 (iter1 best)",                       params: basePs({ entryDepth: 1 }),                                 filters: {} },
  { name: "ce · 2:1",                                    params: basePs({ entryDepth: 1, targetRMult: 2.0 }),               filters: {} },
  { name: "ce · 4:1",                                    params: basePs({ entryDepth: 1, targetRMult: 4.0 }),               filters: {} },
  { name: "ce · 5:1",                                    params: basePs({ entryDepth: 1, targetRMult: 5.0 }),               filters: {} },
  { name: "ce · 6:1",                                    params: basePs({ entryDepth: 1, targetRMult: 6.0 }),               filters: {} },
  { name: "ce · 3:1 + BUY-only",                         params: basePs({ entryDepth: 1 }),                                 filters: { buyOnly: true } },
  { name: "ce · 3:1 + SELL-only",                        params: basePs({ entryDepth: 1 }),                                 filters: { sellOnly: true } },
  { name: "ce · 3:1 + with-trend@20",                    params: basePs({ entryDepth: 1 }),                                 filters: { withTrendOnlyAboveAdx: 20 } },
  { name: "ce · 3:1 + minAdx=22 (trending)",             params: basePs({ entryDepth: 1 }),                                 filters: { minAdx: 22 } },
  { name: "ce · 3:1 + maxAdx=22 (ranging)",              params: basePs({ entryDepth: 1 }),                                 filters: { maxAdx: 22 } },
  { name: "ce · 3:1 + skipSat",                          params: basePs({ entryDepth: 1 }),                                 filters: { skipDaysOfWeekUtc: [6] } },
  { name: "ce · 3:1 + skipSatSun",                       params: basePs({ entryDepth: 1 }),                                 filters: { skipDaysOfWeekUtc: [0, 6] } },
  // Edge with side bias (Gold may have asymmetric edge)
  { name: "edge · 3:1 + BUY-only",                       params: basePs(),                                                  filters: { buyOnly: true } },
  { name: "edge · 3:1 + SELL-only",                      params: basePs(),                                                  filters: { sellOnly: true } },
  // 2:1 had highest WR (36%) in iter1 — try with quality
  { name: "edge · 2:1 + minAdx=22",                      params: basePs({ targetRMult: 2.0 }),                              filters: { minAdx: 22 } },
  { name: "edge · 2:1 + skipSat",                        params: basePs({ targetRMult: 2.0 }),                              filters: { skipDaysOfWeekUtc: [6] } },
  { name: "edge · 2:1 + maxAdx=22",                      params: basePs({ targetRMult: 2.0 }),                              filters: { maxAdx: 22 } },
  { name: "edge · 2:1 + BUY-only",                       params: basePs({ targetRMult: 2.0 }),                              filters: { buyOnly: true } },
  { name: "edge · 2:1 + SELL-only",                      params: basePs({ targetRMult: 2.0 }),                              filters: { sellOnly: true } },
  // ADX-cap combinations
  { name: "edge · 3:1 + maxAdx=40",                      params: basePs(),                                                  filters: { maxAdx: 40 } },
  { name: "edge · 3:1 + maxAdx=30",                      params: basePs(),                                                  filters: { maxAdx: 30 } },
];
