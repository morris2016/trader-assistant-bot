...
const variants: Variant[] = [
  // ITER1 winners
  { name: "WIN: confirm 5:1 (qualifying)",          params: basePs({ entryOnSweep: 0, targetRMult: 5.0 }),     filters: {} },
  { name: "BUY-promising: confirm 4:1 BUY (17t)",   params: basePs({ entryOnSweep: 0, targetRMult: 4.0 }),     filters: { buyOnly: true } },
  // R:R sweep on confirm + no filter
  { name: "confirm 6:1",                            params: basePs({ entryOnSweep: 0, targetRMult: 6.0 }),     filters: {} },
  { name: "confirm 7:1",                            params: basePs({ entryOnSweep: 0, targetRMult: 7.0 }),     filters: {} },
  { name: "confirm 8:1",                            params: basePs({ entryOnSweep: 0, targetRMult: 8.0 }),     filters: {} },
  // R:R sweep on confirm + BUY-only (only 17-19 trades; need to find way to add)
  { name: "confirm 5:1 + BUY",                      params: basePs({ entryOnSweep: 0, targetRMult: 5.0 }),     filters: { buyOnly: true } },
  { name: "confirm 6:1 + BUY",                      params: basePs({ entryOnSweep: 0, targetRMult: 6.0 }),     filters: { buyOnly: true } },
  // ICT + BUY + higher R:R (140 → 60-69 trades, may carry edge to qualification)
  { name: "ICT 5:1 + BUY",                          params: basePs({ targetRMult: 5.0 }),                      filters: { buyOnly: true } },
  { name: "ICT 6:1 + BUY",                          params: basePs({ targetRMult: 6.0 }),                      filters: { buyOnly: true } },
  // Sweep selectivity - more equal-highs/lows to fire
  { name: "confirm 5:1 + minEqual=3",               params: basePs({ entryOnSweep: 0, targetRMult: 5.0, minEqualCount: 3 }), filters: {} },
  { name: "confirm 5:1 + minEqual=3 + BUY",         params: basePs({ entryOnSweep: 0, targetRMult: 5.0, minEqualCount: 3 }), filters: { buyOnly: true } },
  { name: "confirm 4:1 + minEqual=3 + BUY",         params: basePs({ entryOnSweep: 0, targetRMult: 4.0, minEqualCount: 3 }), filters: { buyOnly: true } },
  // Wider lookback for larger pool
  { name: "confirm 5:1 + lbBars=80",                params: basePs({ entryOnSweep: 0, targetRMult: 5.0, lookbackBars: 80 }), filters: {} },
  { name: "confirm 5:1 + lbBars=80 + BUY",          params: basePs({ entryOnSweep: 0, targetRMult: 5.0, lookbackBars: 80 }), filters: { buyOnly: true } },
  { name: "confirm 4:1 + lbBars=80 + BUY",          params: basePs({ entryOnSweep: 0, targetRMult: 4.0, lookbackBars: 80 }), filters: { buyOnly: true } },
  // Stack confirm 5:1 with day filter / ADX
  { name: "confirm 5:1 + skipSat",                  params: basePs({ entryOnSweep: 0, targetRMult: 5.0 }),     filters: { skipDaysOfWeekUtc: [6] } },
  { name: "confirm 5:1 + minAdx=22",                params: basePs({ entryOnSweep: 0, targetRMult: 5.0 }),     filters: { minAdx: 22 } },
  { name: "confirm 5:1 + minAdx=18",                params: basePs({ entryOnSweep: 0, targetRMult: 5.0 }),     filters: { minAdx: 18 } },
  { name: "confirm 5:1 + maxAdx=40",                params: basePs({ entryOnSweep: 0, targetRMult: 5.0 }),     filters: { maxAdx: 40 } },
  // confirm 3:1 + minAdx=22 looked good (+$284) — push that R:R
  { name: "confirm 4:1 + minAdx=22",                params: basePs({ entryOnSweep: 0, targetRMult: 4.0 }),     filters: { minAdx: 22 } },
  { name: "confirm 5:1 + minAdx=22 + BUY",          params: basePs({ entryOnSweep: 0, targetRMult: 5.0 }),     filters: { minAdx: 22, buyOnly: true } },
  // Smaller swing window — more sweep candidates
  { name: "confirm 5:1 + swing1",                   params: basePs({ entryOnSweep: 0, targetRMult: 5.0, swingLeft: 1, swingRight: 1 }), filters: {} },
  { name: "confirm 5:1 + swing1 + BUY",             params: basePs({ entryOnSweep: 0, targetRMult: 5.0, swingLeft: 1, swingRight: 1 }), filters: { buyOnly: true } },
  { name: "confirm 4:1 + swing1 + BUY",             params: basePs({ entryOnSweep: 0, targetRMult: 4.0, swingLeft: 1, swingRight: 1 }), filters: { buyOnly: true } },
];
