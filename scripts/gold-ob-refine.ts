...
const variants: Variant[] = [
  // ITER2 WIN baseline
  { name: "WIN: ce · 3:1 + BUY-only",                    params: basePs({ entryDepth: 1 }),                                 filters: { buyOnly: true } },
  // R:R sweep around BUY-only
  { name: "ce · 2:1 + BUY",                              params: basePs({ entryDepth: 1, targetRMult: 2.0 }),               filters: { buyOnly: true } },
  { name: "ce · 4:1 + BUY",                              params: basePs({ entryDepth: 1, targetRMult: 4.0 }),               filters: { buyOnly: true } },
  { name: "ce · 5:1 + BUY",                              params: basePs({ entryDepth: 1, targetRMult: 5.0 }),               filters: { buyOnly: true } },
  { name: "ce · 6:1 + BUY",                              params: basePs({ entryDepth: 1, targetRMult: 6.0 }),               filters: { buyOnly: true } },
  // Stack BUY with other filters
  { name: "ce · 3:1 + BUY + skipSat",                    params: basePs({ entryDepth: 1 }),                                 filters: { buyOnly: true, skipDaysOfWeekUtc: [6] } },
  { name: "ce · 3:1 + BUY + skipSatSun",                 params: basePs({ entryDepth: 1 }),                                 filters: { buyOnly: true, skipDaysOfWeekUtc: [0, 6] } },
  { name: "ce · 3:1 + BUY + with-trend@20",              params: basePs({ entryDepth: 1 }),                                 filters: { buyOnly: true, withTrendOnlyAboveAdx: 20 } },
  { name: "ce · 3:1 + BUY + minAdx=22",                  params: basePs({ entryDepth: 1 }),                                 filters: { buyOnly: true, minAdx: 22 } },
  { name: "ce · 3:1 + BUY + maxAdx=22",                  params: basePs({ entryDepth: 1 }),                                 filters: { buyOnly: true, maxAdx: 22 } },
  { name: "ce · 3:1 + BUY + maxAdx=30",                  params: basePs({ entryDepth: 1 }),                                 filters: { buyOnly: true, maxAdx: 30 } },
  { name: "ce · 3:1 + BUY + maxAdx=40",                  params: basePs({ entryDepth: 1 }),                                 filters: { buyOnly: true, maxAdx: 40 } },
  // Edge entry alternative
  { name: "edge · 3:1 + BUY",                            params: basePs(),                                                  filters: { buyOnly: true } },
  { name: "edge · 4:1 + BUY",                            params: basePs({ targetRMult: 4.0 }),                              filters: { buyOnly: true } },
  { name: "edge · 5:1 + BUY",                            params: basePs({ targetRMult: 5.0 }),                              filters: { buyOnly: true } },
  { name: "edge · 3:1 + BUY + skipSat",                  params: basePs(),                                                  filters: { buyOnly: true, skipDaysOfWeekUtc: [6] } },
  { name: "edge · 3:1 + BUY + maxAdx=40",                params: basePs(),                                                  filters: { buyOnly: true, maxAdx: 40 } },
  { name: "edge · 3:1 + BUY + minAdx=22",                params: basePs(),                                                  filters: { buyOnly: true, minAdx: 22 } },
  // Quality on top of BUY
  { name: "ce · 3:1 + BUY + disp1.2",                    params: basePs({ entryDepth: 1, displacementAtrMultiplier: 1.2 }), filters: { buyOnly: true } },
  { name: "ce · 3:1 + BUY + disp1.5",                    params: basePs({ entryDepth: 1, displacementAtrMultiplier: 1.5 }), filters: { buyOnly: true } },
  { name: "ce · 3:1 + BUY + requireFVG",                 params: basePs({ entryDepth: 1, requireFVG: 1 }),                  filters: { buyOnly: true } },
];
