...
const variants: Variant[] = [
  // ITER5 WIN: edge·4:1+BUY+obSearch=5+lookback8+disp0.6 = +$555.64 / 30t / 40% WR / +0.81R
  { name: "WIN-iter5",                                   params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.6 }), filters: { buyOnly: true } },
  // lookback fine sweep around 8
  { name: "lb6",                                         params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 6, displacementAtrMultiplier: 0.6 }), filters: { buyOnly: true } },
  { name: "lb7",                                         params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 7, displacementAtrMultiplier: 0.6 }), filters: { buyOnly: true } },
  { name: "lb9",                                         params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 9, displacementAtrMultiplier: 0.6 }), filters: { buyOnly: true } },
  { name: "lb10",                                        params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 10, displacementAtrMultiplier: 0.6 }), filters: { buyOnly: true } },
  // disp fine sweep around 0.6
  { name: "disp0.4",                                     params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.4 }), filters: { buyOnly: true } },
  { name: "disp0.5",                                     params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.5 }), filters: { buyOnly: true } },
  { name: "disp0.7",                                     params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.7 }), filters: { buyOnly: true } },
  // R:R fine sweep
  { name: "R3.75:1",                                     params: basePs({ targetRMult: 3.75, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.6 }), filters: { buyOnly: true } },
  { name: "R4.25:1",                                     params: basePs({ targetRMult: 4.25, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.6 }), filters: { buyOnly: true } },
  { name: "R4.5:1",                                      params: basePs({ targetRMult: 4.5, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.6 }), filters: { buyOnly: true } },
  // Combined nudges
  { name: "lb7+disp0.5",                                 params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 7, displacementAtrMultiplier: 0.5 }), filters: { buyOnly: true } },
  { name: "lb6+disp0.5",                                 params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 6, displacementAtrMultiplier: 0.5 }), filters: { buyOnly: true } },
  { name: "lb8+disp0.5+R4.5",                            params: basePs({ targetRMult: 4.5, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.5 }), filters: { buyOnly: true } },
  { name: "lb8+disp0.7+R4.5",                            params: basePs({ targetRMult: 4.5, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.7 }), filters: { buyOnly: true } },
  // ATR period sweep on top of winner
  { name: "atrP=10",                                     params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.6, atrPeriod: 10 }), filters: { buyOnly: true } },
  { name: "atrP=20",                                     params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.6, atrPeriod: 20 }), filters: { buyOnly: true } },
  // retestBars sweep on top of winner
  { name: "retestBars=1",                                params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.6, retestConfirmationBars: 1 }), filters: { buyOnly: true } },
  { name: "retestBars=3",                                params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.6, retestConfirmationBars: 3 }), filters: { buyOnly: true } },
  // rejection body sweep
  { name: "rejBody=0.2",                                 params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.6, rejectionBodyAtrMul: 0.2 }), filters: { buyOnly: true } },
  { name: "rejBody=0.5",                                 params: basePs({ targetRMult: 4.0, obSearchMaxBack: 5, lookback: 8, displacementAtrMultiplier: 0.6, rejectionBodyAtrMul: 0.5 }), filters: { buyOnly: true } },
];
