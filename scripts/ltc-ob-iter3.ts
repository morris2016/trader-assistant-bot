...
const variants: Variant[] = [
  // ITER2 WIN: +FVG · 3:1 = 46t / 46% WR / +0.63R / +$772.35
  { name: "WIN-iter2: +FVG · 3:1",                      params: basePs({ requireFVG: 1 }),                                 filters: {} },
  // R:R fine sweep around 3:1
  { name: "+FVG · 2.5:1",                               params: basePs({ requireFVG: 1, targetRMult: 2.5 }),               filters: {} },
  { name: "+FVG · 3.5:1",                               params: basePs({ requireFVG: 1, targetRMult: 3.5 }),               filters: {} },
  // Detector params
  { name: "+FVG · 3:1 + obSearch=5",                    params: basePs({ requireFVG: 1, obSearchMaxBack: 5 }),             filters: {} },
  { name: "+FVG · 3:1 + obSearch=4",                    params: basePs({ requireFVG: 1, obSearchMaxBack: 4 }),             filters: {} },
  { name: "+FVG · 3:1 + obSearch=8",                    params: basePs({ requireFVG: 1, obSearchMaxBack: 8 }),             filters: {} },
  { name: "+FVG · 3:1 + lookback=8",                    params: basePs({ requireFVG: 1, lookback: 8 }),                    filters: {} },
  { name: "+FVG · 3:1 + lookback=6",                    params: basePs({ requireFVG: 1, lookback: 6 }),                    filters: {} },
  { name: "+FVG · 3:1 + lookback=16",                   params: basePs({ requireFVG: 1, lookback: 16 }),                   filters: {} },
  { name: "+FVG · 3:1 + disp1.0",                       params: basePs({ requireFVG: 1, displacementAtrMultiplier: 1.0 }), filters: {} },
  { name: "+FVG · 3:1 + disp0.6",                       params: basePs({ requireFVG: 1, displacementAtrMultiplier: 0.6 }), filters: {} },
  { name: "+FVG · 3:1 + retestBars=1",                  params: basePs({ requireFVG: 1, retestConfirmationBars: 1 }),      filters: {} },
  { name: "+FVG · 3:1 + retestBars=3",                  params: basePs({ requireFVG: 1, retestConfirmationBars: 3 }),      filters: {} },
  { name: "+FVG · 3:1 + atrP=10",                       params: basePs({ requireFVG: 1, atrPeriod: 10 }),                  filters: {} },
  { name: "+FVG · 3:1 + atrP=20",                       params: basePs({ requireFVG: 1, atrPeriod: 20 }),                  filters: {} },
  { name: "+FVG · 3:1 + rejBody=0.5",                   params: basePs({ requireFVG: 1, rejectionBodyAtrMul: 0.5 }),       filters: {} },
  { name: "+FVG · 3:1 + rejBody=0.1",                   params: basePs({ requireFVG: 1, rejectionBodyAtrMul: 0.1 }),       filters: {} },
  // Filter stack on +FVG (skipSat / weekend tests)
  { name: "+FVG · 3:1 + skipSat",                       params: basePs({ requireFVG: 1 }),                                 filters: { skipDaysOfWeekUtc: [6] } },
  { name: "+FVG · 3:1 + skipSatSun",                    params: basePs({ requireFVG: 1 }),                                 filters: { skipDaysOfWeekUtc: [0, 6] } },
  // Combined best stacks
  { name: "+FVG · 3:1 + obSearch=5 + lookback=8",       params: basePs({ requireFVG: 1, obSearchMaxBack: 5, lookback: 8 }),filters: {} },
  { name: "+FVG · 3:1 + obSearch=5 + disp0.6",          params: basePs({ requireFVG: 1, obSearchMaxBack: 5, displacementAtrMultiplier: 0.6 }), filters: {} },
];
