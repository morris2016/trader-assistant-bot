// Palladium FVG month-by-month walk-forward.
// Goal: find variant that is positive in EVERY calendar month (no losing month).
// Iteration loop: run → identify failure months → fix variants → re-run.
...
// Iteration 7: 4 only-winning variants in iter 6. Leader: Ace+adx[18,38] +$238.
// Try to push past $300 while staying only-winning — perturbations around the winning band.
const baseAce = { minGapAtrMul: 0.50, targetRMult: 4, stopBufferAtrMul: 0.25, entryDepth: 1 };
const variants: Variant[] = [
  // base
  { name: "iter6: Ace+adx[18,38]",        params: fvgParams(baseAce),                            filters: { minAdx: 18, maxAdx: 38 } },
  // ADX band micro-sweep
  { name: "Ace+adx[19,38]",               params: fvgParams(baseAce),                            filters: { minAdx: 19, maxAdx: 38 } },
  { name: "Ace+adx[20,38]",               params: fvgParams(baseAce),                            filters: { minAdx: 20, maxAdx: 38 } },
  { name: "Ace+adx[17,38]",               params: fvgParams(baseAce),                            filters: { minAdx: 17, maxAdx: 38 } },
  { name: "Ace+adx[18,36]",               params: fvgParams(baseAce),                            filters: { minAdx: 18, maxAdx: 36 } },
  { name: "Ace+adx[18,37]",               params: fvgParams(baseAce),                            filters: { minAdx: 18, maxAdx: 37 } },
  { name: "Ace+adx[18,39]",               params: fvgParams(baseAce),                            filters: { minAdx: 18, maxAdx: 39 } },
  { name: "Ace+adx[20,40]",               params: fvgParams(baseAce),                            filters: { minAdx: 20, maxAdx: 40 } },
  // base + R:R
  { name: "Ace+adx[18,38]·3:1",           params: fvgParams({ ...baseAce, targetRMult: 3 }),     filters: { minAdx: 18, maxAdx: 38 } },
  { name: "Ace+adx[18,38]·3.5:1",         params: fvgParams({ ...baseAce, targetRMult: 3.5 }),   filters: { minAdx: 18, maxAdx: 38 } },
  { name: "Ace+adx[18,38]·5:1",           params: fvgParams({ ...baseAce, targetRMult: 5 }),     filters: { minAdx: 18, maxAdx: 38 } },
  { name: "Ace+adx[18,38]·6:1",           params: fvgParams({ ...baseAce, targetRMult: 6 }),     filters: { minAdx: 18, maxAdx: 38 } },
  // base + stopBuf
  { name: "Ace+adx[18,38]+stopBuf=0.20",  params: fvgParams({ ...baseAce, stopBufferAtrMul: 0.20 }), filters: { minAdx: 18, maxAdx: 38 } },
  { name: "Ace+adx[18,38]+stopBuf=0.30",  params: fvgParams({ ...baseAce, stopBufferAtrMul: 0.30 }), filters: { minAdx: 18, maxAdx: 38 } },
  { name: "Ace+adx[18,38]+stopBuf=0.15",  params: fvgParams({ ...baseAce, stopBufferAtrMul: 0.15 }), filters: { minAdx: 18, maxAdx: 38 } },
  // base + minGap
  { name: "Ace+adx[18,38]+mG=0.45",       params: fvgParams({ ...baseAce, minGapAtrMul: 0.45 }), filters: { minAdx: 18, maxAdx: 38 } },
  { name: "Ace+adx[18,38]+mG=0.55",       params: fvgParams({ ...baseAce, minGapAtrMul: 0.55 }), filters: { minAdx: 18, maxAdx: 38 } },
  // base + side
  { name: "Ace+adx[18,38]+SELL",          params: fvgParams(baseAce),                            filters: { minAdx: 18, maxAdx: 38, sellOnly: true } },
  { name: "Ace+adx[18,38]+BUY",           params: fvgParams(baseAce),                            filters: { minAdx: 18, maxAdx: 38, buyOnly: true } },
  // base + rej
  { name: "Ace+adx[18,38]+rej",           params: fvgParams({ ...baseAce, requireRejection: 1 }), filters: { minAdx: 18, maxAdx: 38 } },
  // base + dynSma
  { name: "Ace+adx[18,38]+dynSma=50",     params: fvgParams(baseAce),                            filters: { minAdx: 18, maxAdx: 38, dynamicSideBySma: 50 } },
  { name: "Ace+adx[18,38]+dynSma=100",    params: fvgParams(baseAce),                            filters: { minAdx: 18, maxAdx: 38, dynamicSideBySma: 100 } },
  { name: "Ace+adx[18,38]+dynSma=200",    params: fvgParams(baseAce),                            filters: { minAdx: 18, maxAdx: 38, dynamicSideBySma: 200 } },
  // big-pull: combine best params
  { name: "Ace+adx[18,38]+mG=0.45+stopBuf=0.20", params: fvgParams({ ...baseAce, minGapAtrMul: 0.45, stopBufferAtrMul: 0.20 }), filters: { minAdx: 18, maxAdx: 38 } },
];
...
async function main() {
  ...
  console.log(`Palladium/USD FVG month-by-month walk-forward · ${variants.length} variants · 1h\n`);
