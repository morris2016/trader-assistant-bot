// Platinum (XPT/USD) OB deep-dive. Precious metal like Silver/Gold but lower retail volume.
// TRAIN/TEST split + warmup methodology to avoid the LTC overfit trap.
...
async function main() {
  ...
  console.log(`[plat-ob-deepdive] Symbol: Platinum/USD (frxXPTUSD) · cost ${COST_BPS} bps · 1h TF`);
