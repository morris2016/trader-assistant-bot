// AUD/JPY OB iter 2 — compound iter 1 winners.
// Iter 1 only-winners: BUY·4:1 (+$65, 4/0/1), minAdx=25·3:1 (+$65, 4/0/1), disp=1.8·3:1 (+$67, 3/0/2).
// Iter 1 best $: lookback=24·3:1 +$102 (4/1/0, Apr -$1). Goal: stack BUY + minAdx + lookback + disp.
...
const variants: Variant[] = [
  // iter 1 carry-overs
  { name: "iter1: BUY·4:1",                        params: obParams({ targetRMult: 4 }),                                            filters: { buyOnly: true } },
  { name: "iter1: minAdx=25·3:1",                  params: obParams(),                                                              filters: { minAdx: 25 } },
  { name: "iter1: lookback=24·3:1",                params: obParams({ lookback: 24 }),                                              filters: {} },
  // pair compounds: BUY × minAdx
  { name: "BUY+minAdx=22·3:1",                     params: obParams(),                                                              filters: { buyOnly: true, minAdx: 22 } },
  { name: "BUY+minAdx=25·3:1",                     params: obParams(),                                                              filters: { buyOnly: true, minAdx: 25 } },
  { name: "BUY+minAdx=28·3:1",                     params: obParams(),                                                              filters: { buyOnly: true, minAdx: 28 } },
  // pair compounds: BUY × lookback
  { name: "BUY+lookback=20·3:1",                   params: obParams({ lookback: 20 }),                                              filters: { buyOnly: true } },
  { name: "BUY+lookback=24·3:1",                   params: obParams({ lookback: 24 }),                                              filters: { buyOnly: true } },
  // pair compounds: BUY × disp
  { name: "BUY+disp=1.5·3:1",                      params: obParams({ displacementAtrMultiplier: 1.5 }),                            filters: { buyOnly: true } },
  { name: "BUY+disp=1.8·3:1",                      params: obParams({ displacementAtrMultiplier: 1.8 }),                            filters: { buyOnly: true } },
  // pair compounds: minAdx × lookback
  { name: "minAdx=25+lookback=24·3:1",             params: obParams({ lookback: 24 }),                                              filters: { minAdx: 25 } },
  { name: "minAdx=25+lookback=20·3:1",             params: obParams({ lookback: 20 }),                                              filters: { minAdx: 25 } },
  // pair compounds: minAdx × disp
  { name: "minAdx=25+disp=1.5·3:1",                params: obParams({ displacementAtrMultiplier: 1.5 }),                            filters: { minAdx: 25 } },
  { name: "minAdx=25+disp=1.8·3:1",                params: obParams({ displacementAtrMultiplier: 1.8 }),                            filters: { minAdx: 25 } },
  // pair compounds: lookback × disp
  { name: "lookback=24+disp=1.5·3:1",              params: obParams({ lookback: 24, displacementAtrMultiplier: 1.5 }),              filters: {} },
  { name: "lookback=24+disp=1.8·3:1",              params: obParams({ lookback: 24, displacementAtrMultiplier: 1.8 }),              filters: {} },
  // R:R sweeps on most promising compounds
  { name: "BUY+minAdx=25·4:1",                     params: obParams({ targetRMult: 4 }),                                            filters: { buyOnly: true, minAdx: 25 } },
  { name: "BUY+lookback=24·4:1",                   params: obParams({ lookback: 24, targetRMult: 4 }),                              filters: { buyOnly: true } },
  { name: "minAdx=25+lookback=24·4:1",             params: obParams({ lookback: 24, targetRMult: 4 }),                              filters: { minAdx: 25 } },
  // triple compounds — full stack
  { name: "BUY+minAdx=25+lookback=24·3:1",         params: obParams({ lookback: 24 }),                                              filters: { buyOnly: true, minAdx: 25 } },
  { name: "BUY+minAdx=25+disp=1.5·3:1",            params: obParams({ displacementAtrMultiplier: 1.5 }),                            filters: { buyOnly: true, minAdx: 25 } },
  { name: "BUY+lookback=24+disp=1.5·3:1",          params: obParams({ lookback: 24, displacementAtrMultiplier: 1.5 }),              filters: { buyOnly: true } },
  // quad compound + R:R variations
  { name: "BUY+minAdx=25+lookback=24+disp=1.5",    params: obParams({ lookback: 24, displacementAtrMultiplier: 1.5 }),              filters: { buyOnly: true, minAdx: 25 } },
  { name: "BUY+minAdx=25+lookback=24·4:1",         params: obParams({ lookback: 24, targetRMult: 4 }),                              filters: { buyOnly: true, minAdx: 25 } },
];
...
async function main() {
  ...
  console.log(`AUD/JPY OB month-by-month walk-forward · ${variants.length} variants · 1h\n`);
